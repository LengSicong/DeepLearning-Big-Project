...
parser.add_argument("--fps", type=float, default=None, help="frames per second")  # TACoS's default fps is 29.4
...
for idx, video_path in enumerate(video_paths):
    ...
    if os.path.exists(image_dir):
        ...
        subprocess.call("ffmpeg -hide_banner -loglevel panic -i {} {}/{}-%6d.jpg".format(video_path, image_dir,
                                                                                         video_id), shell=True)
